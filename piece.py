...
class Piece:
    ...
    def __init__(self, row, col, color): # Avg. Runtime of O(1)
        self.row = row
        self.col = col
        self.color = color
        self.king = False
    ...
    def move(self, row, col): # Avg. runtime of O(1)
        self.row = row
        self.col = col
        self.calculate_pos()
